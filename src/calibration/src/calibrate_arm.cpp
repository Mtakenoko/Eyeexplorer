...
void Marker::setPosition(int marker_id)
{
    ...
    {
    case 0:
        this->Position.x = -0.2335;
        this->Position.y = -0.3685;
        this->Position.z = -0.0560;
        break;
    case 1:
        this->Position.x = -0.2335;
        this->Position.y = -0.3060;
        this->Position.z = -0.0560;
        break;
    case 2:
        this->Position.x = -0.2335;
        this->Position.y = -0.2430;
        this->Position.z = -0.0560;
        break;
    case 3:
        this->Position.x = -0.2335;
        this->Position.y = -0.1803;
        this->Position.z = -0.0560;
        break;
    case 4:
        this->Position.x = -0.2335;
        this->Position.y = -0.3060;
        this->Position.z = -0.1082;
        break;
    case 5:
        this->Position.x = -0.2335;
        this->Position.y = -0.2430;
...
void Calib_Param::projectPoint()
{
    for (auto itr = scene.begin(); itr != scene.end(); itr++)
    {
        ...
        for (auto marker_itr = itr->marker.begin(); marker_itr != itr->marker.end(); marker_itr++)
        {
            ...
            printf("#%d ans:[%0.3lf %0.3lf], opencv:[%0.3lf %0.3lf], my[%0.3lf %0.3lf]\n", marker_itr->ID, marker_itr->Point_Image.x, marker_itr->Point_Image.y, predicted_X, predicted_Y, predicted_x, predicted_y);
