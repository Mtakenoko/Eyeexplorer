...
{
    offset[0] += 0.695877 + 0.170817 - 0.135620 + 0.0197 - 0.03 + 0.0814 + 0.1705;
    offset[1] += 1.313390 - 0.0039 - 0.0422;
    offset[2] += 0.250914 + 0.224633 - 0.368491 + 0.0039 - 0.074 + 0.5257 - 0.48 + 0.0573;
    offset[3] += -2.325260 - 0.054457 + 4.9320 + 0.1909 + 0.05;
    offset[4] += 1.346482 - 3.9817 + 0.2939 - 0.1959 + 0.045;
}