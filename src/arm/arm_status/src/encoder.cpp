...
{
    offset[0] = -0.814928 + 222595;              //-46.2371; //-18.4375 + 17.677004;
    offset[1] = -1.309818 - 0.046571;            //-75.242;  //-81.3766 + 79.902502;
    offset[2] = -0.651488 + 0.432092 - 0.412342; //-18.9048; //53.5832 - 56.141618;
    offset[3] = 2.488054 - 0.04252;              //54.4841;  //177.849 - 174.721681;
    offset[4] = -1.279504 - 0.062087;            //76.7439;  //144.96 - 142.300355;
}