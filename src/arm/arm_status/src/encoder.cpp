...
{
    offset[0] = -0.695877;              //-46.2371; //-18.4375 + 17.677004;
    offset[1] = -1.349390;            //-75.242;  //-81.3766 + 79.902502;
    offset[2] = -0.250914; //-18.9048; //53.5832 - 56.141618;
    offset[3] = 2.325260;              //54.4841;  //177.849 - 174.721681;
    offset[4] = -1.296482;            //76.7439;  //144.96 - 142.300355;
}