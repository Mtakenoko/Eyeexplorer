...
enum OperationMode
{
    ...
    OP_MODE_HOME_POSITIONING,
    OP_MODE_VISUAL_SERVO,
    OP_MODE_SAFETY_CONTROL,
    OP_MODE_NUM
};
...
private:
    ...
    static const double xpp = 1.0 / 20000;  ///< ステージの1パルス当たりの移動量[mm/pulse]
