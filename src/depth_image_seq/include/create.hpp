...
{
public:
    Scene() : flag_set_image(false), flag_set_transform(false), flag_caliculated(false) {}
    bool isInModel(const visualization_msgs::msg::Marker &eyemodel)
    {
...
private:
    ...
    Scene scene;
    int scene_counter;
    std::vector<Scene> scene_container;
