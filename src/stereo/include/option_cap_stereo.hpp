...
bool parse_command_options(
  ...
  size_t * width = nullptr, size_t * height = nullptr, size_t * device_L = nullptr, size_t * device_R = nullptr, bool * movie_mode = nullptr,
  std::string * topic_image_L = nullptr, std::string * topic_image_R = nullptr);
